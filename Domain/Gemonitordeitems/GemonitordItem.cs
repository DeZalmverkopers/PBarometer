...
namespace Domain.Gemonitordeitems
{
  public class GemonitordItem
  {
    ...
    protected virtual void BerekenPolTrend()
    {
      ...
      if (GemPolariteit > vorigePolariteit * 0.9 && GemPolariteit < vorigePolariteit * 1.1)
      {
        PolariteitsTrend = Trend.NEUTRAL;
      }
      else if (GemPolariteit > vorigePolariteit * 1.1)
      {
    ...
    protected virtual void BerekenObjTrend()
    {
      ...
      if (GemObjectiviteit > vorigeObjectiviteit * 0.9 && GemObjectiviteit < vorigeObjectiviteit * 1.1)
      {
        ObjectiviteitsTrend = Trend.NEUTRAL;
      }
      else if (GemObjectiviteit > vorigeObjectiviteit * 1.1)
      {
    ...
    protected virtual void BerekenVermeldingenTrend()
    {
      ...
      if (TotaalAantalVermeldingen > vorigAantalVermeldingen * 0.9 && TotaalAantalVermeldingen < vorigAantalVermeldingen * 1.1)
      {
        VermeldingenTrend = Trend.NEUTRAL;
      }
      else if (TotaalAantalVermeldingen > vorigAantalVermeldingen * 1.1)
      {
