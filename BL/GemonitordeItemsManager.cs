...
namespace BL
{
  public class GemonitordeItemsManager
  {
    ...
    public void AddGekruisdItem(GemonitordItem item1, GemonitordItem item2, string naam, int deelplatformId)
    {
      InitNonExistingRepo();
      GemonitordItem gekruisdItem = new GekruistItem { Naam = naam, DeelplatformId = deelplatformId, Item1 = item1, Item2 = item2 };
      gekruisdItem.BerekenEigenschappen();
      repository.CreateGemonitordItem(gekruisdItem);
    }
