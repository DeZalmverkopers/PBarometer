...
{
	public static MVC.Controllers.AccountController Account = new MVC.Controllers.T4MVC_AccountController();
	public static MVC.Controllers.AdminController Admin = new MVC.Controllers.T4MVC_AdminController();
	public static MVC.Controllers.DashboardController Dashboard = new MVC.Controllers.T4MVC_DashboardController();
	public static MVC.Controllers.GemonitordItemController GemonitordItem = new MVC.Controllers.T4MVC_GemonitordItemController();
	public static MVC.Controllers.GrafiekController Grafiek = new MVC.Controllers.T4MVC_GrafiekController();
	public static MVC.Controllers.HomeController Home = new MVC.Controllers.T4MVC_HomeController();
	public static MVC.Controllers.OverzichtController Overzicht = new MVC.Controllers.T4MVC_OverzichtController();
	public static MVC.Controllers.OverzichtdetailController Overzichtdetail = new MVC.Controllers.T4MVC_OverzichtdetailController();
	public static MVC.Controllers.ProfielController Profiel = new MVC.Controllers.T4MVC_ProfielController();
	public static MVC.Controllers.SuperAdminController SuperAdmin = new MVC.Controllers.T4MVC_SuperAdminController();
	public static MVC.Controllers.WeeklyReviewController WeeklyReview = new MVC.Controllers.T4MVC_WeeklyReviewController();
	public static T4MVC.AlertsController Alerts = new T4MVC.AlertsController();
...
namespace Links
{
	...
	public static class Scripts {
    	...
    	public static readonly string jquery_signalR_2_2_3_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/jquery.signalR-2.2.3.min.js") ? Url("jquery.signalR-2.2.3.min.js") : Url("jquery.signalR-2.2.3.js");
    	public static readonly string jquery_signalR_2_2_3_min_js = Url("jquery.signalR-2.2.3.min.js");
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static partial class esm 
            {
                ...
                {
                    public static readonly string Chart_min_js = T4MVCHelpers.ProcessAssetPath("~/Scripts/esm/Chart.min.js"); 
            ...
            public static class Assets
            {
                ...
                public static readonly string Chart_min_js = T4MVCHelpers.ProcessAssetPath("~/Scripts/Chart.min.js"); 
                ...
                public static readonly string jquery_signalR_2_2_3_js = T4MVCHelpers.ProcessAssetPath("~/Scripts/jquery.signalR-2.2.3.js"); 
                public static readonly string jquery_signalR_2_2_3_min_js = T4MVCHelpers.ProcessAssetPath("~/Scripts/jquery.signalR-2.2.3.min.js"); 
